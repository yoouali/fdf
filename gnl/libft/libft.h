...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/03/29 13:56:22 by akhossan          #+#    #+#             */
/*   Updated: 2019/07/13 09:45:20 by akhossan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_bool			ft_islowcase(int c);
t_bool			ft_isupcase(int c);
...
t_bool			ft_contains(char const *set, char c);
char			*ft_itoa(int n);
